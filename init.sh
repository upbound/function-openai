...
# replacing all instances of function-openai with the
...
# Replace function-openai with the name of your function
# in go.mod
perl -pi -e s,function-openai,"$1",g go.mod
# in fn.go
perl -pi -e s,function-openai,"$1",g fn.go
# in examples
perl -pi -e s,function-openai,"$1",g example/*
